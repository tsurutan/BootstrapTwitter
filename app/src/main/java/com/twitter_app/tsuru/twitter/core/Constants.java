...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.twitter_app.tsuru.twitter";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "Twitter";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.twitter_app.tsuru.twitter.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.twitter_app.tsuru.twitter.";
